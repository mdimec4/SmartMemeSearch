...
namespace SmartMemeSearch.Services
{
    public class ClipService
    {
        ...
        public ClipService()
        {
            ...
            string imageModelPath = Path.Combine(IsPackaged ? Windows.ApplicationModel.Package.Current.InstalledLocation.Path : AppContext.BaseDirectory, "Assets", "clip_image.onnx");
            string textModelPath = Path.Combine(IsPackaged ? Windows.ApplicationModel.Package.Current.InstalledLocation.Path : AppContext.BaseDirectory, "Assets", "clip_text.onnx");
            string tokenizerPath = Path.Combine(IsPackaged ? Windows.ApplicationModel.Package.Current.InstalledLocation.Path : AppContext.BaseDirectory, "Assets", "tokenizer.json");
        ...
        public static string GetAssetPath(string relativePath)
        {
            ...
            // Unpackaged → get literal file path
            string exe = AppContext.BaseDirectory;
            return Path.Combine(exe, "Assets", relativePath);
        }
        */
